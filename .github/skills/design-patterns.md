...
description: Software design patterns applicable to the recommendator codebase. When to use each, and how they map to specific modules. For architect and engineer use.
---
