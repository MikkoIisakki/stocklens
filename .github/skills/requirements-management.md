...
description: Requirements traceability, NFR ownership, change management, and MoSCoW prioritization for the pulse project. Owned by the product-manager agent.
---
