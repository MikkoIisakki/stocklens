---
name: gitops
description: GitOps principles, branch strategy, environment promotion, image tagging, rollback, and drift prevention for the pulse project.
---
...
```
# Tag format
ghcr.io/owner/pulse-backend:<git-sha>      # primary, immutable
ghcr.io/owner/pulse-backend:v0.2.0         # release tag
ghcr.io/owner/pulse-backend:main           # branch tip (dev only)
```
