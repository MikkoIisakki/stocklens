---
name: clean-code
description: Clean code principles and practices for the pulse codebase. Based on Robert C. Martin's Clean Code and related practices. Mandatory for the engineer agent.
---
